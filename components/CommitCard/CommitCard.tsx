      ...
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <div className="flex justify-between">
            ...
            <p className="place-self-end font-terminal! text-secondary small-p">{content.period}</p>
          </div>
          <div className="flex flex-wrap items-center gap-3 ">
            <span className="text-primary-900 font-terminal uppercase">{type === "education" ? education.institution : experience.company}</span>
          </div>
        </div>
