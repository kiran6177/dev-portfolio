...
function Collaborate() {
  ...
  return (
    <div className="my-20 bg-background-700/50 border-2 border-border-800 rounded-xl p-12 flex items-center justify-center">
      <div className="flex flex-col justify-center items-center">
        <h2 className="text-center mb-2">
          Ready to <span className="text-gradient w-fit">Architect your System</span>?
        </h2>
        <p className="text-secondary w-[55%] text-center small-p">{`
